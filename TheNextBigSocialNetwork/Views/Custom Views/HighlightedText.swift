...
struct HighlightedText: View {
    ...
    /// Color used for view background when text value constants textPart value
    var textPartBgColor: Color = Color.clear
    /// Color used for view foreground when text value constants textPart value
    var textPartFgColor: Color = Color.black
    ...
    var maxLineLength = 10000000
    /// False to disable multiline drawing
    var multilineEnabled = false
            ...
            ForEach(textParts) { item in
                if item.highlighted {
                    Text(item.textPart)
                        ...
                        .foregroundColor(textPartFgColor)
...
struct HighlightedText_Previews: PreviewProvider {
    static var previews: some View {
        HighlightedText(text: "TextkjaskbdkjasbdkjTEasbdhbkjaDKJASBDKBASKDETEBASÊDHASBDJHASBDJASBDJHASBDJHSABDJHASBDJHASBDJHASBDHJASDBASJHDBASHJDBHJASDBJHASBDHJASBDJHASDBJHASBDTEXTNASNDKJBASDBHJASDBHJASDBJHASBDJHASBDTESTLKanslanslknASNlanslkaSLKNasdnasnlas",
                        textPart: "text",
                        textPartBgColor: .blue,
                        fontSize: 18)
    }
}
